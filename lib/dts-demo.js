...
var Lr = { exports: {} }, He = {}, Nr = { exports: {} }, _ = {};
/**
 * @license React
...
function Wt() {
  ...
  function pe(n, s, h) {
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        g[C] === void 0 && (g[C] = T[C]);
    return { $$typeof: W, type: n, key: P, ref: k, props: g, _owner: q.current };
  }
  function Re(n, s) {
  ...
  function K(n, s, h, C, g) {
    ...
    if (k)
      return k = n, g = g(k), n = C === "" ? "." + H(k, 0) : C, oe(g) ? (h = "", n != null && (h = n.replace(we, "$&/") + "/"), K(g, s, h, "", function(V) {
        return V;
  ...
  return _.Children = { map: Y, forEach: function(n, s, h) {
    ...
    return { $$typeof: W, type: n.type, key: g, ref: P, props: C, _owner: k };
...
function Vt() {
  return ft || (ft = 1, function(W, y) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      he.constructor = V, h(he, g.prototype), he.isPureReactComponent = !0;
      function yr() {
        var e = {
          current: null
        };
      ...
      function ge(e, r, a, o, i) {
        ...
        if (l) {
          ...
          if (Fe(E)) {
            ...
            E != null && (_e(E) && (E.key && (!v || v.key !== E.key) && Oe(E.key), E = gr(
              E,
        ...
        if (Fe(e))
          for (var vr = 0; vr < e.length; vr++)
            A = e[vr], D = z + Ae(A, vr), M += ge(A, r, a, D, i);
        else {
          var $r = I(e);
          if (typeof $r == "function") {
            var ut = e;
            $r === ut.entries && (Me || ue("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Me = !0);
            for (var $t = $r.call(ut), it, Lt = 0; !(it = $t.next()).done; )
              A = it.value, D = z + Ae(A, Lt++), M += ge(A, r, a, D, i);
          } else if (p === "object") {
            var st = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === re || e === Q || K || e === te || e === U || e === ee || H || e === Ie || Ce || Ue || we || typeof e == "object" && e !== null && (e.$$typeof === se || e.$$typeof === G || e.$$typeof === $ || e.$$typeof === Z || e.$$typeof === L || // This needs to include all possible module reference object
...
Check the top-level render call using <` + a + ">.");
      ...
      y.Children = Ft, y.Component = g, y.Fragment = re, y.Profiler = Q, y.PureComponent = V, y.StrictMode = te, y.Suspense = U, y.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Y, y.cloneElement = Dt, y.createContext = ur, y.createElement = xt, y.createFactory = It, y.createRef = yr, y.forwardRef = Pr, y.isValidElement = _e, y.lazy = Or, y.memo = c, y.startTransition = kt, y.unstable_act = At, y.useCallback = J, y.useContext = R, y.useDebugValue = ie, y.useDeferredValue = vt, y.useEffect = B, y.useId = yt, y.useImperativeHandle = ir, y.useInsertionEffect = x, y.useLayoutEffect = F, y.useMemo = be, y.useReducer = b, y.useRef = m, y.useState = S, y.useSyncExternalStore = ht, y.useTransition = pt, y.version = Ee, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Ke, Ke.exports)), Ke.exports;
}
process.env.NODE_ENV === "production" ? Nr.exports = Wt() : Nr.exports = Vt();
var Mr = Nr.exports;
const Ut = /* @__PURE__ */ Mt(Mr);
/**
 * @license React
...
function Yt() {
  if (lt)
    return He;
  lt = 1;
  var W = Mr, y = Symbol.for("react.element"), Ee = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = W.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, $, Z) {
...
function Bt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === X || t === re || pe || t === de || t === Z || t === L || ce || t === G || oe || N || q || typeof t == "object" && t !== null && (t.$$typeof === ee || t.$$typeof === U || t.$$typeof === te || t.$$typeof === Q || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    function Rr(t, u, c, f, R) {
      {
        ...
        c !== void 0 && (Ye(c), m = "" + c), gr(u) && (Ye(u.key), m = "" + u.key), _r(u) && (B = u.ref, br(u, R));
        for (S in u)
...
process.env.NODE_ENV === "production" ? Lr.exports = Yt() : Lr.exports = Bt();
var zt = Lr.exports;
const qt = Ut.forwardRef(() => /* @__PURE__ */ zt.jsx("div", { children: "button" }));
export {
  qt as Button
};
